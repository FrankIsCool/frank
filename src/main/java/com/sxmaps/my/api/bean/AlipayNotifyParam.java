package com.sxmaps.my.api.bean;
...
public class AlipayNotifyParam implements Serializable {
    ...
    public static AlipayNotifyParam of(String params) {
        return JSON.parseObject(params, AlipayNotifyParam.class);
    }
    public static AlipayNotifyParam of(Map<String, String> params) {
        return of(JSON.toJSONString(params));
    }
}
