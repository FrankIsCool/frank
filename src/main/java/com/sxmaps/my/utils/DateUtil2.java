...
public final class DateUtil2 {
	...
	private static final Log logger = LogFactory.getLog(DateUtil2.class);
...
//		System.out.println("out" + DateUtil.intervalDays(mat.format(new Date()), "2016-09-12"));

		System.out.println(DateUtil2.intervalDays(DateUtil2.toString(new Date(), DateUtil2.FORMAT_DATE), ""));
