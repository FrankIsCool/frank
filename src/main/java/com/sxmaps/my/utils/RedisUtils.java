...
public class RedisUtils {
	...
	public boolean setIfAbsent(String key, Object value, Long seconds) {
		String luaScript = " if 1 == redis.call('setnx',KEYS[1],ARGV[1]) then" + " redis.call('expire',KEYS[1],ARGV[2])"
				+ " return 1;" + " else" + " return 0;" + " end;";

		RedisScript<Boolean> newSetIfAbsentScript = new DefaultRedisScript<Boolean>(luaScript, Boolean.class);
