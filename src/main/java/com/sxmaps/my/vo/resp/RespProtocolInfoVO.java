...
public class RespProtocolInfoVO implements Serializable {

	@ApiModelProperty(name = "orderSn", value = "订单号", example = "123456789", allowEmptyValue = false)
	private String orderSn;
	@ApiModelProperty(name = "orderItemUid", value = "子订单uid", example = "123456789", allowEmptyValue = false)
