    ...
    function () {
        ...
        var e = "SweetAlert2:",
            ...
            X = function (t, e) {
                ...
                else if ("object" === V(t)) if (e.innerHTML = "", 0 in t) for (var n = 0; n in t; n++) e.appendChild(t[n].cloneNode(!0));
                    ...
                    return function (t) {
                        ...
                        return function (t, e) {
                            ...
                            r((n = e).prototype, [{
                                key: "_main",
                                value: function (t) {
                                    return d(c(e.prototype), "_main", this).call(this, s({},
                                        i, t))
                                }
                            }]),
                        o && r(n, o),
        ...
        function ht() {
            ...
            t.showConfirmButton || (W(e.confirmButton), t.showCancelButton || W(e.actions)),
        ...
        function Ct(t) {
            ...
            if (n) {
                ...
                var s = function () {
                    T() ? kt(a) : (new Promise(function (t) {
                        ...
                        ct.restoreFocusTimeout = setTimeout(function () {
                                ct.previousActiveElement && ct.previousActiveElement.focus ? (ct.previousActiveElement.focus(), ct.previousActiveElement = null) : document.body && document.body.focus(),
                                    t()
                            },
                            100),
                    ...
                    E() && (null !== m.previousBodyPadding && (document.body.style.paddingRight = m.previousBodyPadding + "px", m.previousBodyPadding = null),
                        function () {
                ...
                G && !g(n, I.noanimation) ? n.addEventListener(G,
                    function t() {
        ...
        var Bt = function t(e, n) {
                ...
                this.running = !1,
                    this.start = function () {
                        return this.running || (this.running = !0, i = new Date, o = setTimeout(e, r)),
                            r
                    },
                    this.stop = function () {
        ...
        var At = function (t) {
            ...
            null !== t.onBeforeOpen && "function" == typeof t.onBeforeOpen && t.onBeforeOpen(n),
                t.animation ? (D(n, I.show), D(e, I.fade), U(n, I.hide)) : U(n, I.fade),
                z(n),
        ...
        var Pt, St = Object.freeze({
            ...
            enableInput: function () {
                var t = this.getInput();
                if (!t) return !1;
                if ("radio" === t.type) for (var e = t.parentNode.parentNode.querySelectorAll("input"), n = 0; n < e.length; n++) e[n].disabled = !1;
                else t.disabled = !1
            },
            disableInput: function () {
                var t = this.getInput();
                if (!t) return !1;
                if (t && "radio" === t.type) for (var e = t.parentNode.parentNode.querySelectorAll("input"), n = 0; n < e.length; n++) e[n].disabled = !0;
                else t.disabled = !0
            },
            ...
            _main: function (t) {
                ...
                !
                    function (t) {
                        for (var e in t) pt(e) || q('Unknown parameter "'.concat(e, '"')),
                        t.toast && -1 !== dt.indexOf(e) && q('The parameter "'.concat(e, '" is incompatible with toasts')),
                        ft(e) && (n = 'The parameter "'.concat(e, '" is deprecated and will be removed in the next major release. Please use "').concat(ft(e), '" instead.'), -1 === i.indexOf(n) && (i.push(n), q(n)));
                        var n
                    }(t);
                var T = s({},
                    ut, t);
                !
                    function (e) {
                        ...
                        (!e.target || "string" == typeof e.target && !document.querySelector(e.target) || "string" != typeof e.target && !e.target.appendChild) && (q('Target parameter is not valid, defaulting to "body"'), e.target = "body"),
                        ...
                        e.showCloseButton ? (c.setAttribute("aria-label", e.closeButtonAriaLabel), z(c)) : W(c),
                            t.className = I.popup,
                            e.toast ? (D([document.documentElement, document.body], I["toast-shown"]), D(t, I.toast)) : D(t, I.modal),
                        e.customClass && (D(s, e.customClass.container), D(t, "string" == typeof e.customClass ? e.customClass : e.customClass.popup), D(u, e.customClass.header), D(l, e.customClass.title), D(c, e.customClass.closeButton), D(d, e.customClass.content), D(p, e.customClass.actions), D(f, e.customClass.footer)),
                ...
                return new Promise(function (t) {
                    ...
                    for (var c = function (e) {
                            T.showLoaderOnConfirm && M.showLoading(),
                             ...
                             o = O.popup.querySelectorAll("button"), i = 0; i < o.length; i++) o[i].onclick = e,
                        o[i].onmouseover = e,
                        o[i].onmouseout = e,
                        o[i].onmousedown = e;
                    ...
                    var a = function (t, e) {
                        for (var n = $(T.focusCancel), o = 0; o < n.length; o++) return (t += e) === n.length ? t = 0 : -1 === t && (t = n.length - 1),
                            n[t].focus();
                        O.popup.focus()
                    };
                    ...
                    T.toast || (ct.keydownHandler = function (t) {
                        return function (t, e) {
                            if (e.stopKeydownPropagation && t.stopPropagation(), "Enter" !== t.key || t.isComposing) if ("Tab" === t.key) {
                                for (var n = t.target,
                                         o = $(e.focusCancel), i = -1, r = 0; r < o.length; r++) if (n === o[r]) {
                                    i = r;
                                    break
                                }
